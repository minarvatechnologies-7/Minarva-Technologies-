...
## Business facts
Only user-provided facts are represented. Customer claims, reviews, prices, inventory, certifications, awards, employee counts and performance figures are intentionally not fabricated.

## Production integration status
Database, authentication, WhatsApp, email/SMS, payment, analytics and AI provider integrations require real account credentials/configuration. No external action is described as working until it can be connected and tested successfully.

## Verification note
The GitHub repository has been inspected after implementation. Local dependency installation, Prisma client generation, database connectivity, browser QA and production deployment have not been claimed as verified because those runtime environments are not available through the current GitHub connector session.
